...
/**
 * Input connected to 1 first hidden substrate with 3x3 convolutional. First hidden connected to a 1x10 second hidden with full. Last hidden connected to output with full
 * @author Devon Fulcher
 */
public class Skinny1x10Substrate implements SubstrateArchitectureDefinition{
