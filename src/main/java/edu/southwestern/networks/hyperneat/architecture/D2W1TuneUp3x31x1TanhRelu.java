...
public class D2W1TuneUp3x31x1TanhRelu implements SubstrateArchitectureDefinition{
	...
	public List<HiddenSubstrateGroup> getNetworkHiddenArchitecture() {
		...
		networkHiddenArchitecture.add(new HiddenSubstrateGroup(new Pair<Integer, Integer>(8, 18), 1, 1, ActivationFunctions.FTYPE_RE_LU));
