...
public class D2W1ReceptiveField3x3TanhRelu implements SubstrateArchitectureDefinition{
	...
	public List<HiddenSubstrateGroup> getNetworkHiddenArchitecture() {
		...
		networkHiddenArchitecture.add(new HiddenSubstrateGroup(new Pair<Integer, Integer>(6, 16), 1, 1, ActivationFunctions.FTYPE_RE_LU));
